...
```python
(a > 2) & (a < 7)   # AND: [False, True, True, False, False, False]
...
<span style="font-size: 14px;">A boolean mask with the same shape as a two-dimensional array selects matching elements into a one-dimensional result:</span>
